...
This plugin adds an overview mode to your http://markdalgleish.com/projects/bespoke.js[Bespoke.js] presentation, which turns all the slides visible and arranges them on a grid when the kbd:[o] key is pressed.
