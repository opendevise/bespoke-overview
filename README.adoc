...
The bespoke-overview plugin presents an overview of all the slides when either the kbd:[o] or kbd:[esc] key is pressed in a http://markdalgleish.com/projects/bespoke.js[Bespoke.js] presentation.
...
margin _(type: number, default: 10)_::
...
When one of the trigger keys is pressed (i.e., kbd:[o] or kbd:[esc]), all the slides in the presentation become visible and are arranged in a grid layout.
