...
When the kbd:[o] key is pressed in a http://markdalgleish.com/projects/bespoke.js[Bespoke.js] presentation with the bespoke-overview plugin enabled, all the slides are presented in a grid.
