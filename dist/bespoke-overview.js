  ...
  return function(deck) {
    ...
    activateOverview = function() {
      ...
      slides.forEach(function(slide) {
        ...
        slide.style[transformProperty] = 'translate(' + x + 'px, ' + y + 'px) scale(' + scale + ')';
      ...
      if (activeSlideIndex >= columns && numTransitions === 0) slides[activeSlideIndex].scrollIntoView(true);
    },
    ...
    if (!!opts.autostart) activateOverview();
  };
};
